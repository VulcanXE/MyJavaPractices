...
Sample4 Sample4Obj = new Sample4();// creating a class for int i
...
System.out.println(Sample4.a);//best to access/ call static variable is with class name
Sample4 Sample4Obj1 = new Sample4();
Sample4Obj1.k = 8944;// it doen't effect the sample obj k value
